        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body chartjs" style="max-height: 458px !important;" style="height: 500px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            <canvas id="myChartSignal" height="458" width="1542" style="display: block; width: 1542px; height: 458px;" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body chartjs" style="max-height: 458px !important;" style="height: 500px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            <canvas id="myChartSignal123" height="458" width="1542" style="display: block; width: 1542px; height: 458px;" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body chartjs" style="max-height: 458px !important;" style="height: 500px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            <canvas id="myChartSignal1234" height="458" width="1542" style="display: block; width: 1542px; height: 458px;" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
        ...
        .then(fileContentsArray => {
            ...
            for (var i = 0; i < fileContentsArray.length-1; i++) {
...
<script>
    ...
    // Fayllarni o'qish uchun massiv
    var fileNames = [];
    fileNames.push("/<?=$model->signal_1?>")

    <?php foreach($signallar as $m){?>
    ...
    Promise.all(filePromises)
    .then(fileContentsArray => {
        for (let i = 1; i < fileContentsArray.length-1; i++) {
        ...
        let array = chiqan_qiymat;
            ...
            console.log("Index of the smallest 1-signalik value:", smallestIndex+1);
...
<script>
    ...
    .then(fileContentsArray => {
        for (let i = 1; i < fileContentsArray.length-1; i++) {
            ...
            chiqan_qiymat1.push(manhattanDistance);
        }
        // console.log(chiqan_qiymat);
        let array = chiqan_qiymat1;
            ...
            // Print the smallest value and its index
            console.log("Smallest value:", smallestValue);
            console.log("Index of the smallest 2-signalik value:", smallestIndex+1);
            // localStorage.setItem('signal1', smallestIndex);
            let variable = fileContentsArray[smallestIndex+1]
            // console.log(variable);
            //chart chizish bunda biyog'i
...
<script>
    ...
    .then(fileContentsArray => {
        for (let i = 1; i < fileContentsArray.length-1; i++) {
            ...
            chiqan_qiymat2.push(manhattanDistance);
        }
        // console.log(chiqan_qiymat);
        let array = chiqan_qiymat2;
