                  ...
                  <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                     <div class="card-header border-0">
                        <div class="card-title text-center">
                           <img src="/web/backend/app-assets/images/logo/logo-dark.png" alt="branding logo">
                        </div>
                     ...
                     <div class="card-content">
                        ...
                        <div class="card-body">
                           ...
                           <fieldset class="form-group position-relative has-icon-left">
                              <input type="text" class="form-control" id="user-name" name="LoginForm[username]" placeholder="Your Username" required>
                              <div class="form-control-position">
                                 <i class="la la-user"></i>
                              </div>
                           </fieldset>
                           <fieldset class="form-group position-relative has-icon-left">
                              <input type="password" class="form-control" id="user-password" name="LoginForm[password]" placeholder="Enter Password" required>
                              <div class="form-control-position">
                                 <i class="la la-key"></i>
                              </div>
                           </fieldset>
                           ...
                           <?= Html::submitButton('<i class="ft-unlock"></i> Логин', ['class' => 'btn btn-outline-info btn-block', 'name' => 'login-button']) ?>
                           <!-- </form> -->
                           <?php ActiveForm::end(); ?>
                        </div>
